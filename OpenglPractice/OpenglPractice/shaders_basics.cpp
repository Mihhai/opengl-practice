...
static const char* fgShaderInputColorSource =
"#version 330 core\n"
"in vec3 someColor;\n"
"out vec4 FragColor;\n"
"void main()\n"
...
static const char* vertexShaderColorSource = 
"#version 330 core\n"
...
int shader_basics() {
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);// instructions for interpreting the first vertex attribute
	...
	glShaderSource(vertexShader, 1, &vertexShaderColorSource, NULL);
	...
	glShaderSource(fragmentShader, 1, &fgShaderInputColorSource, NULL);
